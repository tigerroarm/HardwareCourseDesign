...
bool scrHeaderTimeResp( ScreenHeaderTime *scrHeaderInst, AreaRange *absPos )
{
    ...
    if ( timeFlag.autoTurnPageFlag )
    {
        ...
        printf( "该自动翻页了\n" );
        printf( "autoTurnPage = %s\n", tftlcdScreenInst.scrSetting.autoTurnPage ? "true":"false" );
        //翻页
...
//    }
	...
	//debug
//	printf( "\n" );
//	printf( "curSecondsCount = %d\n", timeFlag.curSecondsCount );
//	printf( "alarmSeconds = %d\n", timeFlag.alarmSeconds );
//	printf( "autoTPSeconds = %d\n", timeFlag.autoTPSeconds );
//	printf( "curATPSecCount = %d\n", timeFlag.curATPSecCount );
//	printf( "alarmSecCount = %d\n", timeFlag.alarmSecCount );
//
//	printf( "alarmState = %s\n", timeFlag.alarmState ? "true":"false" );
//	printf( "timeChangeFlag = %s\n", timeFlag.timeChangeFlag ? "true":"false" );
//	printf( "alarmFlag = %s\n", timeFlag.alarmFlag ? "true":"false" );
//	printf( "autoTurnPageFlag = %s\n", timeFlag.autoTurnPageFlag ? "true":"false" );
//
//	printf( "autoTurnPage = %s\n", tftlcdScreenInst.scrSetting.autoTurnPage ? "true":"false" );
