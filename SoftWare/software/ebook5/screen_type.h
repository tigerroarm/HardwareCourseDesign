...
////编码格式
enum encodingFmt { GBK = 0, UCS2_BIG = 1, UCS2_LITTLE = 2 };
...
typedef struct
{
	...
	AreaRange tagFileNameArea; //显示文件名称
	TagBlock tagFileName; //文件名

    AreaRange tagPageCodeArea;//编码标签， 格式为："UCS LITTLE","GBK" 等
	TagBlock tagPageCode;

	AreaRange tagFileSizeArea;//文件大小， 格式为："15.3KB"
	TagBlock tagFileSize;
