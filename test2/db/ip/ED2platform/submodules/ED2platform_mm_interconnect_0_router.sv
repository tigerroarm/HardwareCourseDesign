...
(
    ...
    localparam PAD10 = log2ceil(64'h8201468 - 64'h8201460); 
    localparam PAD11 = log2ceil(64'h8201470 - 64'h8201468); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8201470;
    ...
    // ( 0x8201410 .. 0x8201420 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 28'h8201410   ) begin
    ...
    // ( 0x8201460 .. 0x8201468 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 28'h8201460  && read_transaction  ) begin
            src_channel = 12'b001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x8201468 .. 0x8201470 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 28'h8201468   ) begin
