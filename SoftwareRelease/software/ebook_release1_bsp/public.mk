...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../ED2platform.sopcinfo
...
# Design Name 
# setting SOPC_NAME is ED2platform
SOPC_NAME := ED2platform
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x18002070
SOPC_SYSID_FLAG += --sidp=0x18002070
ELF_PATCH_FLAG  += --sidp 0x18002070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1559872952
SOPC_SYSID_FLAG += --timestamp=1559872952
ELF_PATCH_FLAG  += --timestamp 1559872952
