...
void TP_Drow_Touch_Point(unsigned short int x,unsigned short int y,unsigned short int color);//画一个坐标校准点
void TP_Draw_Big_Point(unsigned short int x,unsigned short int y,unsigned short int color);	//画一个大点
void TP_Save_Adjdata(void);								//保存校准参数
unsigned char TP_Get_Adjdata(void);						//读取校准参数
void TP_Adjust(void);									//触摸屏校准
void TP_Adj_Info_Show(unsigned short int x0,unsigned short int y0,unsigned short int x1,unsigned short int y1,unsigned short int x2,unsigned short int y2,unsigned short int x3,unsigned short int y3,unsigned short int fac);//显示校准信息
...
void logical2physical(unsigned short xl, unsigned short yl, unsigned short* addx,  unsigned short* addy);						//转换逻辑坐标到物理坐标
